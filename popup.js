...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
  ...
  var Ut2, Ht2, DocumentSnapshot$1, QueryDocumentSnapshot$1, AppliableConstraint, QueryConstraint, QueryFieldFilterConstraint, QueryCompositeFilterConstraint, QueryOrderByConstraint, QueryLimitConstraint, SnapshotMetadata, DocumentSnapshot, QueryDocumentSnapshot, QuerySnapshot;
  ...
  var require_popup = __commonJS({
    "src/popup.js"() {
      ...
      var $q = (q2) => document.querySelector(q2);
      var resumeBanner = $2("resumeBanner");
      var resumeTitle = $2("resumeTitle");
      var resumeTime = $2("resumeTime");
      var resumeProgressFill = $2("resumeProgressFill");
      var resumeThumb = $2("resumeThumb");
      var resumeBtn = $2("resumeBtn");
      var emptyState = $2("emptyState");
      var historyList = $2("historyList");
      var entryCount = $2("entryCount");
      var gridToggle = $2("gridToggle");
      var clearAllBtn = $2("clearAllBtn");
      var viewAllBtn = $2("viewAllBtn");
      var viewMode = "grid";
      var manualTitle = $2("manualTitle");
      var manualUrl = $2("manualUrl");
      var manualTime = $2("manualTime");
      var saveManualBtn = $2("saveManualBtn");
      var closeBtn = $2("closeBtn");
      var authContent = $2("authContent");
      var loginForm = $2("loginForm");
      var profileView = $2("profileView");
      var syncStatus = $2("syncStatus");
      var userEmail = $2("userEmail");
      var cloudLog = $2("cloudLog");
      var emailInput = $2("emailInput");
      var passwordInput = $2("passwordInput");
      var loginBtn = $2("loginBtn");
      var registerBtn = $2("registerBtn");
      var googleBtn = $2("googleBtn");
      var logoutBtn = $2("logoutBtn");
      var settingsBtn = $2("settingsBtn");
      function fmt(s) {
      ...
      function ago(iso) {
        ...
        const m = Math.floor(d / 6e4), h = Math.floor(d / 36e5), dy = Math.floor(d / 864e5);
      ...
      function startRealtimeHistoryUpdates(uid) {
        stopRealtimeHistoryUpdates();
        const q2 = query(collection(db, `users/${uid}/history`), orderBy("savedAt", "desc"), limit(42));
        unsubscribeHistory = onSnapshot(q2, (snapshot) => {
          const cloudEntries = [];
          snapshot.forEach((doc2) => cloudEntries.push(doc2.data()));
